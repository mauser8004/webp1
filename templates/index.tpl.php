...
Szoftver
		 <iframe width="320" height="240" style="float: right;"
			src="https://www.youtube.com/embed/LwZ35wZJreU?si=DqqDYrqAPYrLerAw">
		</iframe> 
...
Forgalomban lévő modellek<br>


    Arduino/Genuino UNO<br>

Széles körben használt modell, 8 bites, 16 MHz-es ATmega328P processzorral. 14 digitális I/O lábbal és 32 kB flash memóriával rendelkezik.[2]<br>

    Arduino/Genuino 101<br>

Egy kétmagos, kis fogyasztású, 32 bites, 32 MHz-es Intel Curie processzorral, Bluetooth LE támogatással rendelkező lap, ugyanazon perifériákkal, mint az UNO. Flash memóriája 192 kB méretű.[3]<br>

    Arduino/Genuino Micro<br>

Kisméretű, ATmega32U4 processzorral rendelkező változat, amely micro USB csatlakozóval rendelkezik és breadboardon való használatra tervezték. Beépített USB vezérlője van, aminek segítségével akár egérként vagy billentyűként is működhet. 32 kB flash memóriája van.[4]<br>

    Arduino/Genuino Mega 2560<br>

Összetettebb projekthez használható, 54 digitális I/O és 16 analóg bemeneti lábbal. ATmega2560 processzor és 256 kB flash memória van benne.[5]<br>

    Arduino/Genuino Zero<br>

32 bites, nagyobb számítási teljesítményű változata az UNO-nak. Atmel SAMD21 processzor és 256 kB flash memória van benne. Előnye, hogy beépített debuggere is van.[6]<br>

    Arduino/Genuino MKR1000<br>
...
<p>Már nem gyártott modellek<br>
...
<br>
    Arduino WiFi Shield 101<br>
    Arduino Proto Shield<br>
    Arduino MKR Proto Shield<br>
    Arduino MKR Proto Large Shield<br>
